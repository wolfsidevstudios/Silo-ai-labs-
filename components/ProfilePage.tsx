...
const ProfilePage: React.FC = () => {
    ...
    return (
        <div className="animate-fade-in max-w-4xl mx-auto">
             {isSettingsOpen && viewedProfile && (
                <SettingsModal profile={viewedProfile} onClose={() => setIsSettingsOpen(false)} />
            )}
            <header className="flex flex-col md:flex-row items-center gap-8 mb-12">
                ...
                <div className="flex-1 text-center md:text-left">
                    <div className="flex items-center justify-center md:justify-start gap-4 mb-4">
                        ...
                        {isOwnProfile ? (
                            <button onClick={() => setIsSettingsOpen(true)} className="flex items-center gap-2 px-4 py-2 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-colors text-sm font-semibold">
                                <GearIcon />
                                Settings
                            </button>
                        ) : (
